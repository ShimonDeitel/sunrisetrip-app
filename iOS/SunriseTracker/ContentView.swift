        ...
        NavigationStack {
            ZStack {
                ...
                if store.items.isEmpty {
                    ContentUnavailableView("No Sightings Yet", systemImage: "tray", description: Text("Tap + to log your first one."))
                } else {
                    List {
            ...
            .navigationTitle("Sunrise Tracker")
            .toolbar {
...
struct AddItemView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section {
                    TextField("Location", text: $titleText)
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let item = Sighting(title: titleText.isEmpty ? "Sighting" : titleText, value2: value2Text, notes: notesText)
                        if store.add(item) {
                            dismiss()
                        }
                    }
