...
struct SettingsView: View {
    ...
    @AppStorage("sunrisetracker_showNotes") private var showNotes: Bool = true
    @AppStorage("sunrisetracker_compactList") private var compactList: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/sunrisetrip-app/privacy.html")!)
                        .accessibilityIdentifier("settingsPrivacyLink")
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/sunrisetrip-app/terms.html")!)
